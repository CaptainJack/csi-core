...
import ru.capjack.tool.csi.core.OutgoingMessage
import ru.capjack.tool.csi.core.OutgoingMessageBuffer
...
internal class InternalClientImpl(
	...
	private inner class MessagingProcessor(private val receiver: ClientMessageReceiver) :
	...
	private inner class RecoveryProcessor(private val receiver: ClientMessageReceiver) :
		InternalClientProcessor {
