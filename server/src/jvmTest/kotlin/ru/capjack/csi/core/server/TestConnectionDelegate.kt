...
import ru.capjack.csi.core.server.internal.ConnectionDelegateImpl
...
import ru.capjack.csi.core.server.stubs.DummyConnection
import ru.capjack.csi.core.server.stubs.DummyConnectionProcessor
import ru.capjack.csi.core.server.stubs.DummyConnectionReleaser
...
class TestConnectionDelegate {
	...
	fun `POC close after close`() {
		...
		delegate.handleInput(ArrayByteBuffer(1) { writeByte(1) })
		delegate.close()
